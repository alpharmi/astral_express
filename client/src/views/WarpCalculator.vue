<template>
    <h1 class="text-4xl pb-2 text-title font-bold">{{$t('wc.innerTitle')}}</h1>
    <p class="w-[300px] whitespace-normal break-all">{{$t('wc.innerDesc')}}</p>
    <Split/>
    <div class="grid grid-cols-2 md:flex md:gap-10 flex-wrap gap-5">
        ...
        <div class="flex flex-wrap gap-10">
            <div class="bgcontainer w-full h-auto flex flex-wrap p-5 gap-5 items-center justify-center">
                <div>
                    <p class="text-xl"><span class="text-title">{{ total_jades }}x</span> {{ $t('wc.terms.stellarJade') }}</p>
                    <div class="pl-5">
            ...
            <div class="bgcontainer w-full h-auto flex flex-wrap p-5 gap-5 items-center justify-center">
                <div>
                    <p class="flex flex-row gap-1">{{ $t('terms.softPity') }}: <span class="text-title">{{ soft_pity }}</span>
...
<script>
    export default {
        data() {
            return {
                star_rail_special_pass: 0, stellar_jade: 0, oneiric_shard: 0, undying_embers: 0, undying_starlight:0,
