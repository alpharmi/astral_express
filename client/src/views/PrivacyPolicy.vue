<template>
    <h1 class="text-4xl pb-2 text-title font-bold">Privacy Policy</h1>
    <p class="pb-2">How and what data does Astral Express handle <br>and what it's used for.</p>
    <Split/>
    <p class="text-title font-bold text-xl">What does Astral Express collect</p>
