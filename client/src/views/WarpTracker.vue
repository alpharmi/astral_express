  ...
  <div class="flex flex-col gap-2 w-full">
    <div class="flex justify-between items-center">
      ...
      <div class="flex flex-col gap-2">
        <button class="button p-3 px-20 font-bold text-xl inline-image justify-center items-center" @click="redirect('/warp/import')">
          <img src="/images/other/import.png">{{ $t('wh.menu.import') }}
        </button>
        <button class="button p-3 px-20 font-bold text-xl inline-image justify-center items-center" @click="redirect('/warp/global')">
    ...
    <div class="flex flex-row gap-10">
      <div class="w-40 min-w-[10rem] flex flex-col gap-2 child:drop-shadow-2xl child:transition-all child:duration-75">
        <button :class="[{ 'pl-0': banner == 'character' }, { 'pl-8': banner != 'character' }]" @click="switchBanner('character')">
          <img :src="`/images/tickets/${currentBanner}.png`">
        </button>
        <button :class="[{ 'pl-0': banner == 'light_cone' }, { 'pl-8': banner != 'light_cone' }]" @click="switchBanner('light_cone')">
          <img :src="`/images/tickets/${currentBanner}_lightCone.png`">
        </button>
        <button :class="[{ 'pl-0': banner == 'regular' }, { 'pl-8': banner != 'regular' }]" @click="switchBanner('regular')">
        ...
        <div class="flex flex-col gap-5">
          <div class="flex flex-row gap-5">
            ...
            <div class="bgcontainer w-[37.25rem] h-[16.75rem] p-2">
              <WarpHistory v-if="monthlyPulls" :monthly-pulls="monthlyPulls" />
          ...
          <div>
            <div class="bgcontainer flex flex-col w-[37.25rem] gap-3 p-5">
              <div class="flex flex-row justify-center gap-3 child:h-12 child:w-12 child:justify-center child:items-center child:pl-2 child:transition-colors">
                <button :class="{ 'bg-[#ffb13f] bg-opacity-20': filters.legendary }" class="buttonSquare inline-image" @click="filterWarps('legendary')">
                  5<img src="/images/other/star.png">
                </button>
                <button :class="{ 'bg-[#ffb13f] bg-opacity-20': filters.rare }" class="buttonSquare inline-image hue-rotate-[250deg]" @click="filterWarps('rare')">
                  4<img src="/images/other/star.png">
                </button>
                <button :class="{ 'bg-[#ffb13f] bg-opacity-20': filters.common }" class="buttonSquare inline-image hue-rotate-180" @click="filterWarps('common')">
              ...
              <table class="w-full text-left">
                ...
                <tr v-for="(warp, index) in warps" :key="index" :class="`warp-${warp[4]}`" class="border-t border-gray-900 child:font-normal child:py-2">
                  ...
                  <th :style="`color: hsl(${warp[6]},100%,70%)`" class="text-center pr-2">
                    {{ warp[5] }}
                  </th>
                  <th class="inline-image gap-3 capitalize">
                    <img :class="[{ 'scale-[1.5]': warp[2] == 'light_cone' }, { 'scale-[2]': warp[2] == 'character' }]" :src="`/images/${warp[2]}/${warp[1]}.webp`">{{ warp[1].replaceAll("_", " ") }}
                  </th>
